...
12. **`12-case-study-revision-instructions.md`** — **read now if you have a v1 case study built and want to upgrade it to publish-ready.** Critical fixes, missing sections drafted as ready-to-paste HTML, design recommendations, stand-out moves.
